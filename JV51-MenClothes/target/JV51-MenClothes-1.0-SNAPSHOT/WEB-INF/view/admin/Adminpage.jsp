...
<div id="main-wrapper">
    ...
    <div class="page-wrapper">
        <div class="container-fruit">
            <div class="row">
                <div class="card-body">
                <h6 class="card-title">ADMIN PAGE</h6>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-6">
                    <form class="form-horizontal">
                        <div class="card-body">
                    <iframe src="https://calendar.google.com/calendar/embed?src=dinhconghuandn85%40gmail.com&ctz=Indian%2FChristmas" style="border: 0" width="500" height="400" frameborder="0" scrolling="no"></iframe>
                        </div>
                    </form>
                        </div>
            </div>
