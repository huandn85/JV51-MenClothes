...
<%--                    <form class="form-horizontal">--%>
                        <div class="card-body">
                            ...
                            <form:form  modelAttribute ="product" action="addproduct" method="post">
                                ...
                                <div class="col-sm-9">
                                    <form:input type="text" class="form-control" id="fname" placeholder="Enter Name Product Here" path="name"/>
                                </div>
                                         </div>
                                <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <form:input type="text" class="form-control" id="fname" placeholder="Enter Name Product Here" path="importPrice"/>
                                </div>
                            </div>
                                <div class="form-group row">
                                <label  class="col-sm-3 text-right control-label col-form-label">Price</label>
                                <div class="col-sm-9">
                                    <form:input type="text" class="form-control" id="fname" placeholder="Enter Name Product Here" path="price"/>
                                ...
                                <div class="col-sm-9">
                                    <form:input type="text" class="form-control" id="fname"  path="quantitys"/>
                                </div>
                            </div>
                                <div class="form-group row">
                                <label  class="col-sm-3 text-right control-label col-form-label">Date</label>
                                <div class="col-sm-9">
                                    <form:input type="text" class="form-control" id="fname" placeholder="Enter Date" path="dates"/>
                                </div>
                            </div>
                                <div class="form-group row">
                                <label  class="col-sm-3 text-right control-label col-form-label">Discription</label>
                                <div class="col-sm-9">
                                    <form:textarea class="form-control" placeholder="Enter Discription" path="descriptions" />
                                </div>
                            </div>
