                        ...
                        <div class="card-body">
                            ...
                            <form:form  modelAttribute ="product" action="updateP" method="post">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <form:input type="text" class="form-control" id="fname" placeholder="Enter Category" path="categoryId" value="${product.categoryId}"/>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <form:input type="text" class="form-control" id="fname" placeholder="Enter Name Product Here" path="quantity" value="${product.quantity}"/>
                                </div>
                            </div>
                                <div class="form-group row">
                                <label  class="col-sm-3 text-right control-label col-form-label">Date</label>
                                <div class="col-sm-9">
                                    <form:input type="text" class="form-control" id="fname" placeholder="Enter Name Product Here" path="date" value="${product.date}"/>
                                </div>
                            </div>
                                <div class="form-group row">
                                <label  class="col-sm-3 text-right control-label col-form-label">Discription</label>
                                <div class="col-sm-9">
                                    <form:textarea class="form-control" placeholder="Enter Date" path="description" value="${product.description}"/>
                                </div>
                            </div>
